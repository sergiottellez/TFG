...
<head>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  <script async="async" src="https://cdn.rawgit.com/sergiottellez/TFG/c8867463/src/main/webapp/WEB-INF/jsp/ControlListado.js"/>
  ...
  <div class="col-md-6">
   <h4 class="text-center">Lista de SOCIOS. USUARIO:</h4>
                    ...
                    <div class="panel-body">
                        <form id="listar" action="verListaFiltrada" method="POST">              
                            <label> Tipo de busqueda: </label>
                            <div id="txt">
                                <input type="text" id="textoBusqueda" value=" "  name="textoTipoBusqueda" />
                            </div>
                             <br/> 
                            <select id="tipoListadoNumero"  name="tipoListadoNumero" onchange="campoBusqueda(this.value)">
                                <option itemValue="0" itemLabel="Email" label="Email"/>
                                <option itemValue = "1" itemLabel = "Universidad" label="Universidad"/>
                                <option itemValue = "4" itemLabel = "Región" label="Region"/> 
                                <option itemValue = "3" itemLabel = "Activos" label="Usuarios Activos" />
                                <option itemValue = "5" itemLabel = "Nombre" label="Nombre" />
                                <option itemValue = "6" itemLabel = "Todos" label="Todos" />
       
                            </select>
                            
                            <br/>
                              <button class="btn btn-success"><i class="glyphicon glyphicon-edit"></i>Buscar</button>         
                            <br/>
                            
                            <c:out value="${sessionScope.tipoListado}" />
                        </form>
                    </div>
